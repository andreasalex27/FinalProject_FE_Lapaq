    ...
    const fetchProducts = async () => {
      try {
        const response = await fetch(
          "https://6524d82aea560a22a4ea298b.mockapi.io/product"
        );
    ...
    <>
      ...
      <div className="container-lg bg" style={{ backgroundColor: "#2B2A4C" }}>
        <div className="d-flex">
          ...
          <div className="text-white text-end motivasi justify-content-center align-items-center ms-auto py-3 pe-3">
            ...
            <button className="btn btn-danger btn-sm border border-white">
              Daftar Sekarang
            </button>
          </div>
        </div>
      ...
      <div className="mt-3 mb-4">
        <div className="container">
          <h4
            className="ms-2 mt-4 fs-5 fw-semibold"
            style={{ color: "#2B2A4C" }}>
            Kecantikan
          </h4>
