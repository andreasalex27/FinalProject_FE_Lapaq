...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const { namaDepan, namaBelakang, email, password, conPassword, noNIK, alamat, cbKebijakan } = formData;

    if (!namaDepan || !namaBelakang || !email || !password || !conPassword || !alamat || !noNIK) {
      Swal.fire({
        icon: 'error',
