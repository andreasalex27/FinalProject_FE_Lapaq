...
const TransactionOrder = () => {
  ...
  const handleBayarAction = (productId) => {
    const updatedProducts = products.map(product => {
      if (product._id === productId) {
        product.buttonTextBayar = 'Di Bayar';
      }
      return product;
    });
    Swal.fire({
  ...
  const handleReturnAction = (productId) => {
    const updatedProducts = products.map(product => {
      if (product._id === productId) {
        product.buttonTextReturn = 'DiReturn'; // Mengubah teks tombol
      }
      return product;
    });
    setProducts(updatedProducts);
  ...
  const handleNilaiAction = (productId) => {
    const updatedProducts = products.map(product => {
      if (product._id === productId) {
        product.buttonTextNilai = 'Nilai'; // Mengubah teks tombol
      }
      return product;
    });
    setProducts(updatedProducts);
