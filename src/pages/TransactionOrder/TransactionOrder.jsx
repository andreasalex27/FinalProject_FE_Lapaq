...
const TransactionOrder = () => {
  ...
  return (
    <>
      ...
      <div className='bayar container mt-3 p-1 mt-0 rounded' style={{ display: activeFilter === 'Bayar' ? 'block' : 'none', width: '360px' }}>
        <div className='row g-2 mx-1'>
          {products.map((product, index) => (
            <div className='card mb-1 py-3 px-2 border border-0' key={index} style={{ boxShadow: '0 3px 2px rgba(0, 0, 0, 0.1)'}}>
      ...
      <div className='return container mt-3 p-1 mt-0 rounded' style={{ display: activeFilter === 'Return' ? 'block' : 'none', width: '360px'  }}>
                ...
                <Link to='/homepage/transaksi/return' className="text-decoration-none">
                    <div className='row g-0 d-flex align-items-center'>
                        ...
                        <div className='col-md-10'>
                            <div className='card-body d-flex justify-content-between align-items-center p-0 ps-3'>
                                <div>
                                    <h5 style={{ fontSize: "14px" }} className="card-title fw-bold text-black">{product.payload.nama_produk}</h5>
                                    <p className="card-text" style={{ color: '#2B2A4C', fontSize: "14px" }}><span>Rp </span>{product.payload.harga}</p>
                                </div>
                                {activeFilter === 'Return' && (
                                    <div className='d-flex justify-content-between align-items-center'>
      ...
      <div className='nilai container mt-3 p-1 mt-0 rounded' style={{ display: activeFilter === 'Nilai' ? 'block' : 'none', width: '360px'  }}>
        <div className='row g-2 px-1'>
          {products.map((product, index) => (
            <div key={index} className='card mb-1 py-3 px-2 border border-0' style={{ boxShadow: '0 3px 2px rgba(0, 0, 0, 0.1)' }}>
