                ...
                <div className="details d-flex flex-column justify-content-between flex-grow-1 ms-2">
                    <div className="title d-flex justify-content-between align-items-center">
                        ...
                        <div className="button-container">
                            <button className="btn btn-sm fw-bold" style={{ backgroundColor: '#B31312', color: 'white', fontSize: '11px', height: '25px', width: '70px'}}>
                                <Link to="/homepage/dashboard/profile" className='text-decoration-none text-white'>Lihat</Link>
                            </button>
                        </div>
                    </div>
                </div>
