        ...
        <div className="body d-flex justify-content-center align-items-center" style={{ backgroundColor: '#B31312', fontFamily: 'Montserrat, sans-serif', fontSize: '12px', height: '100vh' }}>
            <div className="container-md p-0 pb-5" style={{ maxWidth: '390px', backgroundColor: 'white', margin: 'auto', height: '100%' }}>
                <div className='pt-4 pb-1' style={{boxShadow: '0 3px 3px rgba(0, 0, 0, 0.5)', marginBottom: '3px'}}>
                    <p className='text-center fs-6 fw-bold' style={{color: '#B31312'}}>Lihat Penilaian</p>
                </div>

                <div className='border-bottom mx-5 mt-4 pb-1'>
                    <p className='fs-6 fw-bold mb-0' style={{color: '#2B2A4C'}}>Rianti Kamila</p>
                </div>

                <div className='m-5'>
                    <div>
                        <p className='fs-6 mb-2' style={{color: '#B31312'}}>{product.nama_produk}</p>
                    </div>
                    ...
                    <div>
                        <p>Sesuai pesanan, jaketnya lembut tapi ada sedikit cacat pada bagian sisinya</p>
                    </div>
