        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <div key={filterIcon.id} className="col-4 d-flex justify-content-center align-items-center">
                    <button className='btn btn-lg btn-block mb-3 rounded-circle'
                        style={{
                            backgroundColor: activeFilter === filterIcon.id ? '#B31312' : '#EEE2DE',
                            color: activeFilter === filterIcon.id ? '#FFFFFF' : '#B31312', width: '60px', height: '60px'
                        }}
            ...
            {activeFilter === 'kemas' && (
                <div className="row m-3">
                    ...
                    <div key={product._id} className="product-card d-flex align-items-center rounded mb-3 py-1 px-2" style={{boxShadow: '0 3px 2px rgba(0, 0, 0, 0.1)'}}>
                        <div className="image">
                            <img className="rounded" src={product.image} alt={product.nama_produk} width="70px" height="70px"/>
                        </div>
                        <div className="title ms-3" style={{width: '225px'}}>
                            ...
                            <div className='mt-2'>
                                <p style={{color: '#2B2A4C'}}>Produk sedang di kemas penjual</p>
                            </div>
                        </div>
                    </div>
                    ))}
