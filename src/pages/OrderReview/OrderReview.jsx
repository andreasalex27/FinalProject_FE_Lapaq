  ...
  return (
    <>
      <div className='pt-4 pb-1' style={{boxShadow: '0 3px 3px rgba(0, 0, 0, 0.5)', marginBottom: '3px'}}>
        <p className='text-center fs-6 fw-bold' style={{color: '#B31312'}}>Penilaian Pesanan</p>
      </div>

      <div className='selesai container p-1 mt-0 rounded'>
        <div className='row g-2 justify-content-center'> {/* Menggunakan justify-content-center */}
          {products.map(product => (
            <div key={product._id} className='card mb-1 py-3 px-2 border border-0' style={{ boxShadow: '0 3px 2px rgba(0, 0, 0, 0.1)', width: '350px' }}>
              <Link to={`/homepage/dashboard/riwayat/penilaian/detail/${product._id}`} className="text-decoration-none">
