  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result) {
        ...
        Swal.fire({
          icon: 'success',
          title: '<span style="font-size: 16px; color: green;">Berhasil masuk toko</span>',
          showConfirmButton: false,
          width: '300px',
          timer: '3000',
        });
        ...
        Swal.fire({
          icon: 'warning',
          title: '<span style="font-size: 16px; color: red;">Gagal masuk toko</span>',
          showConfirmButton: false,
          width: '300px',
          timer: '3000',
        });
  ...
  return (
    <div className="body d-flex justify-content-center align-items-center" style={{ backgroundColor: '#B31312', overflow: 'auto', height:'100vh'}}>
      <div className="container pt-5 mb-0" style={{ maxWidth: '390px', backgroundColor: 'white', height: '100%' }}>
        ...
        <h1 className="text-center fs-3 my-5 fw-bold" style={{ color: '#B31312' }}>Masuk Toko</h1>
        ...
        <form className="mx-4 mt-4 mb-1" onSubmit={handleSubmit}>
          ...
          <div className="d-grid gap-2 mt-5">
              <button type="submit" className="btn mb-2 fw-bold text-white" style={{ backgroundColor: '#B31312'}}>Masuk Toko</button>
          </div>
        </form>

        <div className='text-center' style={{fontSize: '13px'}}>
          <span>Belum punya toko?</span>
          <span className='ms-2'><Link to = '/homepage/daftar-toko' className='text-decoration-none'>Daftar toko</Link></span>
        </div>
